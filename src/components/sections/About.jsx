      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="flex justify-center">
            ...
            <div className="relative group w-full max-w-md">
              ...
              <div className="absolute inset-0 -z-10">
                <div className="absolute inset-0 bg-gradient-to-br from-amber-500 via-cyan-500 to-blue-500 rounded-[2.5rem] blur-2xl opacity-25 group-hover:opacity-40 transition-opacity duration-500"></div>
                <div className="absolute -inset-3 bg-gradient-to-tl from-cyan-500 via-blue-500 to-amber-500 rounded-[3rem] blur-3xl opacity-15 group-hover:opacity-30 transition-opacity duration-700 animate-pulse"></div>
              </div>
              
              {/* Image Container with Dynamic Size */}
              <div className="relative w-full aspect-[3/4] md:aspect-[2/3] lg:h-[500px]">
                {/* Animated Glowing Border */}
                <div className="absolute -inset-1 bg-gradient-to-br from-amber-400 via-cyan-400 to-blue-400 rounded-[2rem] opacity-70 group-hover:opacity-100 blur-sm group-hover:blur transition-all duration-300"></div>
                ...
                <div className="relative h-full rounded-[2rem] overflow-hidden border-4 border-slate-900/40 shadow-2xl shadow-amber-500/20 transform group-hover:scale-[1.02] transition-all duration-500">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 via-transparent to-cyan-500/5"></div>
                  ...
                  {/* Info Badge on Hover */}
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-slate-900/95 via-slate-900/80 to-transparent p-5 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                ...
                <div className="absolute top-0 left-1/4 w-20 h-1 bg-gradient-to-r from-transparent via-cyan-400 to-transparent opacity-50"></div>
                <div className="absolute bottom-0 right-1/4 w-20 h-1 bg-gradient-to-r from-transparent via-amber-400 to-transparent opacity-50"></div>
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-amber-400 to-cyan-400 bg-clip-text text-transparent">{t.about.skills}</h3>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {skills.map((skill, index) => (
                <div key={index} className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 backdrop-blur-sm rounded-lg p-3 text-center hover:from-cyan-500/20 hover:to-blue-500/20 border border-cyan-500/20 hover:border-cyan-400/40 transition-all hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/20">
                  {skill}
                </div>
              ))}
            </div>
